...
function upkeep() {
    ...
    remote_version=$(curl -fsSL "https://raw.githubusercontent.com/Trustzone-A-S/TZ-bot-lego/dev-testing/version.txt"  | tr -d '\r' | tr -d '\n' | xargs)
    ...
    if version_gt "$remote_version" "$local_version"; then
        ...
        if [[ "$update_choice" == "y" ]]; then
            curl -fsSL "https://raw.githubusercontent.com/Trustzone-A-S/TZ-bot-lego/dev-testing/tz-lego-combined.sh" \
